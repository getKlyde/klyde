...
GitHub Actions will build the sdist/wheel, publish to PyPI via Trusted Publishing, and create a GitHub Release with autogenerated notes. Ensure PyPI Trusted Publishing is configured for `getKlyd/klyd` and the `pypi` environment in GitHub before tagging.
